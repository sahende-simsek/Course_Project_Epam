...
function Start-Servers {
    ...
    $already3000 = Get-NetTCPConnection -LocalPort 3000 -ErrorAction SilentlyContinue
    if ($already3000) {
    ...
    $already3001 = Get-NetTCPConnection -LocalPort 3001 -ErrorAction SilentlyContinue
    if ($already3001) {
        ...
        $check3001 = Get-NetTCPConnection -LocalPort 3001 -ErrorAction SilentlyContinue
        if ($check3001) {
